        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 p-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="relative group">
                    <div className="absolute inset-0 bg-green-300 rounded-3xl opacity-30 transform translate-y-2 translate-x-2 blur-sm"></div>

                    <div className="relative bg-white rounded-3xl p-8 border-b-8 border-r-8 border-green-300 shadow-2xl overflow-hidden">
                        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-green-200 to-blue-200 rounded-full blur-3xl opacity-30 transform translate-x-1/2 -translate-y-1/2 animate-pulse pointer-events-none"></div>
                        ...
                        <div className="relative bg-white rounded-3xl p-8 border-b-8 border-r-8 border-purple-200 shadow-xl overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="w-full group/submit relative bg-gradient-to-br from-green-400 to-green-600 text-white font-black py-6 px-8 rounded-2xl border-b-8 border-green-800 shadow-2xl hover:shadow-3xl active:border-b-0 active:translate-y-2 transition-all duration-200 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
                                >
