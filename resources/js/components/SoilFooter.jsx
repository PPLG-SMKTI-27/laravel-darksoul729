...
const SOCIAL_LINKS = [
    ...
    },
    {
        ...
        href: GITHUB_URL,
        target: '_blank',
        bg: 'bg-[linear-gradient(180deg,#d97706_0%,#b45309_100%)]',
        glow: 'bg-amber-500/30',
        stroke: 'border-t-[#fdba74] border-b-[#2d1a0f] border-x-[#ea580c]',
...
const SoilSysControlBridge = () => {
    ...
    return (
        <div ref={bridgeRef} className="w-full relative select-none" style={{ background: '#2a1610' }}>
            <style>{`
