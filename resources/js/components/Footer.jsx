...
const SysControlBridge = ({ t }) => {
        ...
        <svg className={className} viewBox="0 0 100 100" preserveAspectRatio={preserveAspectRatio}>
            ...
            {NET_NODES.map(n => (
                <g key={n.id} transform={`translate(${n.x},${n.y})`}>
                    ...
                    <circle
                        r="2.5"
                        fill={n.active ? '#0ea5e9' : '#1e293b'}
                        stroke={n.active ? '#bae6fd' : '#475569'}
                        strokeWidth="0.6"
                        className={n.active ? 'node-active' : 'node-idle'}
                    />
                    <text
                        fontSize="2.8"
                        fill={n.active ? '#bae6fd' : '#475569'}
                        textAnchor="middle"
                        dy="5.8"
    ...
    return (
        <div ref={bridgeRef} className="w-full relative select-none" style={{ background: t.chassisBg }}>
            ...
            <div className="w-full h-[3px]" style={{ background: t.sideBorder }} />
            ...
            <div className="absolute top-0 left-0 w-8 md:w-[60px] lg:w-[100px] h-full border-r-[4px] shadow-[inset_-4px_0_15px_rgba(0,0,0,0.4),inset_2px_0_10px_rgba(255,255,255,0.15)] z-10 hidden sm:flex flex-col items-center justify-around py-6" style={{ background: t.sidePlate, borderRightColor: t.sideBorder }}>
                <div className="w-3.5 h-3.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className="w-2 h-[1.5px] rotate-45" style={{ background: t.screwLine }} />
                </div>
                <div className="w-2.5 h-2.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className={`w-1.5 h-1.5 rounded-full ${t.ledColor} ${t.ledShadow} led-blink`} />
                </div>
                <div className="w-3.5 h-3.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className="w-2 h-[1.5px] -rotate-45" style={{ background: t.screwLine }} />
                </div>
            </div>
            <div className="absolute top-0 right-0 w-8 md:w-[60px] lg:w-[100px] h-full border-l-[4px] shadow-[inset_4px_0_15px_rgba(0,0,0,0.4),inset_-2px_0_10px_rgba(255,255,255,0.15)] z-10 hidden sm:flex flex-col items-center justify-around py-6" style={{ background: t.sidePlate, borderLeftColor: t.sideBorder }}>
                <div className="w-3.5 h-3.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className="w-2 h-[1.5px] rotate-[110deg]" style={{ background: t.screwLine }} />
                </div>
                <div className="w-2.5 h-2.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className="w-1.5 h-1.5 rounded-full bg-yellow-400 shadow-[0_0_6px_#facc15]" />
                </div>
                <div className="w-3.5 h-3.5 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                    <div className="w-2 h-[1.5px] rotate-12" style={{ background: t.screwLine }} />
                </div>
            </div>
            ...
            <div className="relative z-10 flex items-center justify-center w-full max-w-[1240px] mx-auto px-2 py-3">
                <div className="w-full rounded-[16px] border-[2px] border-b-[4px] border-t-black/40 border-l-black/30 shadow-[inset_0_15px_30px_rgba(0,0,0,0.8),0_2px_0_rgba(255,255,255,0.08)] p-3 relative" style={{ background: t.panelGrad, borderRightColor: t.panelBorderR + '66', borderBottomColor: t.panelBorderB + '99' }}>
                    ...
                    <div className="absolute top-[-10px] left-1/2 -translate-x-1/2 z-20 rounded px-3 py-[2px] shadow-[inset_0_2px_4px_rgba(0,0,0,0.8),0_2px_4px_rgba(0,0,0,0.5)]" style={{ background: t.sideBorder + '33', border: `1px solid ${t.sideBorder}` }}>
                        <span className="font-mono text-[9px] tracking-[0.25em] font-bold" style={{ color: t.isContact ? '#fca5a5' : '#38bdf8' }}>SYS_CTRL_BRIDGE</span>
                    </div>
                    ...
                    <div className="flex gap-3 items-stretch mt-2">
                        ...
                        <button
                            ...
                            className="flex-1 min-w-0 bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#38bdf8]/50 border-b-[#38bdf8] shadow-[inset_0_4px_25px_rgba(0,0,0,1),inset_0_-2px_15px_rgba(56,189,248,0.15),0_4px_6px_rgba(0,0,0,0.4)] relative overflow-hidden aspect-[16/9] min-h-[140px] md:min-h-[200px] lg:min-h-[230px] text-left group"
                        ...
                        >
                            ...
                            {/* CRT grid */}
                            <div className="absolute inset-0 opacity-[0.06]" style={{ backgroundImage: 'linear-gradient(rgba(56,189,248,1) 1px,transparent 1px),linear-gradient(90deg,rgba(56,189,248,1) 1px,transparent 1px)', backgroundSize: '12px 12px' }} />
                            {/* Scanbar */}
                            <div className="absolute inset-0 overflow-hidden opacity-30 pointer-events-none z-10">
                                <div className="absolute left-0 right-0 h-5 bg-gradient-to-b from-transparent via-[#38bdf8]/25 to-transparent" style={{ animation: 'scan-bridge 3s linear infinite' }} />
                            </div>
                            {/* Screen label */}
                            <div className="absolute top-1.5 left-2 z-20 flex items-center gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-[#4ade80] shadow-[0_0_6px_#4ade80] led-blink" />
                                <span className="font-mono text-[7px] text-[#38bdf8] tracking-widest font-bold opacity-80">NET_TOPOLOGY</span>
                            </div>
                            <div className="absolute bottom-1.5 right-2 z-20 font-mono text-[7px] tracking-[0.28em] text-[#7dd3fc] opacity-0 group-hover:opacity-90 transition-opacity">
                                OPEN_MAP
                            </div>
                        ...
                        {/* ── Divider groove ── */}
                        <div className="w-[2px] bg-[#0a206a] shadow-[1px_0_0_rgba(255,255,255,0.08)] rounded-full self-stretch shrink-0" />

                        {/* CENTER: Radar Screen */}
                        <div className="flex-shrink-0 bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#34d399]/50 border-b-[#34d399] shadow-[inset_0_4px_25px_rgba(0,0,0,1),inset_0_-2px_15px_rgba(52,211,153,0.12),0_4px_6px_rgba(0,0,0,0.4)] relative overflow-hidden flex items-center justify-center p-2 w-[150px] md:w-[170px] lg:w-[190px] min-h-[140px] md:min-h-[200px] lg:min-h-[230px]">
                            {/* Bezel highlight */}
                            <div className="absolute top-0 left-0 right-0 h-5 bg-gradient-to-b from-white/10 to-transparent z-20 pointer-events-none rounded-t-[8px]" />
                            {/* Screen label */}
                            <div className="absolute top-1.5 left-2 z-20 flex items-center gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-[#34d399] shadow-[0_0_6px_#34d399] led-blink" style={{ animationDelay: '0.4s' }} />
                                <span className="font-mono text-[7px] text-[#34d399] tracking-widest font-bold opacity-80">RADAR</span>
                            </div>
                            <svg viewBox="0 0 120 112" width="130" height="112" className="relative z-10">
                                ...
                                {/* Rings */}
                                {[16, 30, 44, 56].map(r => (
                                    <circle key={r} cx="60" cy="60" r={r} fill="none" stroke="#14532d" strokeWidth="0.8" />
                                ))}
                                <line x1="4" y1="60" x2="116" y2="60" stroke="#14532d" strokeWidth="0.6" />
                                <line x1="60" y1="4" x2="60" y2="116" stroke="#14532d" strokeWidth="0.6" />
                                ...
                                {blips.map(b => {
                                    ...
                                    return <circle key={b.id} cx={bx} cy={by} r="2.8" fill="#4ade80" stroke="#86efac" strokeWidth="0.8"
                                        style={{ filter: 'drop-shadow(0 0 4px #4ade80)', animation: `blink-led2 ${1.4 + b.id * 0.5}s step-end infinite` }} />;
                                })}
                                <circle cx="60" cy="60" r="3" fill="#34d399" style={{ filter: 'drop-shadow(0 0 4px #34d399)' }} />
                                <text x="60" y="106" textAnchor="middle" fontSize="5.5" fill="#34d399" fontFamily="monospace" fontWeight="bold" opacity="0.6">RADAR_SCAN</text>
                            </svg>
                        </div>
                        ...
                        <div className="flex-shrink-0 flex flex-col gap-2 hidden md:flex w-[150px] lg:w-[190px]">
                            {/* SYS MONITOR */}
                            <div className="flex-1 bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#fbbf24]/40 border-b-[#fbbf24]/60 shadow-[inset_0_4px_15px_rgba(0,0,0,1),0_4px_6px_rgba(0,0,0,0.4)] relative overflow-hidden p-2">
                            ...
                            {/* NET STATUS */}
                            <div className="flex-1 bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#38bdf8]/40 border-b-[#38bdf8]/60 shadow-[inset_0_4px_15px_rgba(0,0,0,1),0_4px_6px_rgba(0,0,0,0.4)] relative overflow-hidden p-2">
                                <div className="absolute top-0 left-0 right-0 h-4 bg-gradient-to-b from-white/10 to-transparent rounded-t-[8px] pointer-events-none" />
                                <div className="flex items-center gap-1 mb-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-[#38bdf8] shadow-[0_0_5px_#38bdf8] led-blink" style={{ animationDelay: '0.7s' }} />
                                    <span className="font-mono text-[7px] text-[#38bdf8] tracking-widest font-bold opacity-80">NET_STATUS</span>
                                </div>
                                {[
                                    ...
                                    { label: 'STATUS', val: 'ONLINE', color: '#34d399', blink: true },
                                ].map(s => (
            ...
            {isMapOpen && (
                <div className="fixed inset-0 z-[999] flex items-center justify-center bg-slate-950/80 backdrop-blur-sm">
                    ...
                    <div className="relative w-[92vw] max-w-5xl">
                        <div className="absolute -inset-1 rounded-[22px] bg-[linear-gradient(120deg,#1e3a8a,#0ea5e9,#1e3a8a)] opacity-70 blur-[10px]" />
                        <div className="relative rounded-[22px] border border-[#1e40af] bg-[#050b1f] shadow-[0_30px_80px_rgba(0,0,0,0.6)] overflow-hidden">
                            <div className="flex items-center justify-between px-5 py-3 border-b border-[#0b1e4a] bg-[#06102c]">
                                <div className="flex items-center gap-2">
                                    <div className="w-2 h-2 rounded-full bg-[#22d3ee] shadow-[0_0_10px_#22d3ee]" />
                                    <span className="font-mono text-[10px] tracking-[0.35em] text-[#7dd3fc]">LOS_SANTOS_NET</span>
                                </div>
                                <button
                                    type="button"
                                    onClick={() => setIsMapOpen(false)}
                                    className="px-3 py-1.5 text-[10px] font-mono tracking-[0.25em] text-[#fbbf24] border border-[#3b82f6] rounded-lg bg-[#0b1b44] shadow-[inset_0_0_10px_rgba(15,118,110,0.5)] hover:text-white hover:border-[#38bdf8] transition"
                                >
                                    CLOSE
                                </button>
                            </div>
                            <div className="relative p-4 sm:p-6">
                                <div className="absolute inset-0 opacity-[0.08]" style={{ backgroundImage: 'linear-gradient(rgba(59,130,246,1) 1px,transparent 1px),linear-gradient(90deg,rgba(59,130,246,1) 1px,transparent 1px)', backgroundSize: '18px 18px' }} />
                                <div className="absolute inset-0 pointer-events-none">
                                    <div className="absolute left-0 right-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[#38bdf8] to-transparent opacity-70" />
                                    <div className="absolute left-0 right-0 bottom-0 h-[2px] bg-gradient-to-r from-transparent via-[#38bdf8] to-transparent opacity-70" />
                                </div>
                                <div className="relative aspect-[16/9] rounded-[16px] border border-[#1e3a8a] bg-[#020617] overflow-hidden">
                                    <NetworkMap className="absolute inset-0 w-full h-full" />
                                    <div className="absolute left-4 bottom-4 font-mono text-[10px] tracking-[0.3em] text-[#38bdf8]">
                                        SAT_GRID_VIEW
                                    </div>
...
const Footer = ({ page }) => {
    ...
    // ── Theme tokens: blue (default) vs red (Contact page) ──────────────────
    const isContact = page === 'Contact';
    const t = isContact ? {
        isContact: true,
        // Outer chassis
        chassisBg: '#3b0a0a',   // deep crimson metal
        chassisBorder: '#7f1d1d',
        // Inner panel background
        panelGrad: 'linear-gradient(160deg,#5c1a1a 0%,#3b0a0a 50%,#1c0404 100%)',
        panelBorderR: '#7f1d1d',
        panelBorderB: '#991b1b',
        // Side plates
        sidePlate: '#3b0a0a',
        sideBorder: '#7f1d1d',
        // Screw colors
        screwBase: 'from-[#1c0404] to-[#7f1d1d]',
        screwLine: '#1c0404',
        // Seam dots
        seamL: 'bg-[#7f1d1d]',
        // Nav button
        navBtn: 'bg-[linear-gradient(180deg,#dc2626_0%,#991b1b_100%)]',
        navBtnBorder: 'border-t-[#f87171]/60 border-l-[#dc2626]/40 border-r-[#7f1d1d]/80 border-b-[#450a0a]',
        navBtnShadow: 'inset 0 4px 6px rgba(255,255,255,0.15), inset 0 -4px 6px rgba(0,0,0,0.6), 0 6px 1px #1c0404, 0 8px 12px rgba(0,0,0,0.6)',
        // Bottom strip
        stripBg: '#1c0404',
        stripBorder: '#7f1d1d',
        bevelBg: '#3b0a0a',
        bevelBorderT: 'border-[#dc2626]/40',
        // Side screw dots
        screwDot: 'bg-[#7f1d1d] border-[#991b1b]/50',
        // Center CRT panel
        crtPanel: '#020817',
        // Ambient glow color behind nav buttons
        glowBg: 'bg-red-700/20',
        // Groove divider
        groove: 'bg-[#7f1d1d]',
        // Side hole LED
        ledColor: 'bg-red-500',
        ledShadow: 'shadow-[0_0_8px_#ef4444]',
    } : {
        isContact: false,
        chassisBg: '#1b4cc5',
        chassisBorder: '#3b82f6',
        panelGrad: 'linear-gradient(160deg,#103098 0%,#0f2b87 50%,#091b5e 100%)',
        panelBorderR: '#153ebf',
        panelBorderB: '#1e4dc8',
        sidePlate: '#1b4cc5',
        sideBorder: '#0a2780',
        screwBase: 'from-[#050f30] to-[#153ebf]',
        screwLine: '#020617',
        seamL: 'bg-[#0a206a]',
        navBtn: 'bg-[linear-gradient(180deg,#3b82f6_0%,#1e40af_100%)]',
        navBtnBorder: 'border-t-[#60a5fa]/60 border-l-[#3b82f6]/40 border-r-[#1e40af]/80 border-b-[#172554]',
        navBtnShadow: 'inset 0 4px 6px rgba(255,255,255,0.2), inset 0 -4px 6px rgba(0,0,0,0.5), 0 6px 1px #0a1338, 0 8px 12px rgba(0,0,0,0.6)',
        stripBg: '#0d2578',
        stripBorder: '#1e4dc8',
        bevelBg: '#102e8a',
        bevelBorderT: 'border-[#3b82f6]/40',
        screwDot: 'bg-[#0a206a] border-[#1e4dc8]/50',
        crtPanel: '#020817',
        glowBg: 'bg-[#3b82f6]/20',
        groove: 'bg-[#0a206a]',
        ledColor: 'bg-cyan-400',
        ledShadow: 'shadow-[0_0_8px_#22d3ee]',
    };
    ...
    return (
        <footer className="relative z-50 w-full mt-24 md:mt-40 select-none pb-0">
            ...
            <SysControlBridge t={t} />

            {/* Main Outer Chassis (Heavy Blue Metal) */}

            <div className="w-full border-y-[2px] shadow-[0_-15px_30px_rgba(0,0,0,0.3)] relative flex flex-col items-center" style={{ background: t.chassisBg, borderColor: t.chassisBorder }}>

                {/* Very outer side plates (Visual filler for extreme left/right edges like image) */}
                <div className="absolute top-0 left-0 w-8 md:w-[60px] lg:w-[120px] h-full border-r-[4px] shadow-[inset_-4px_0_15px_rgba(0,0,0,0.4),_inset_2px_0_10px_rgba(255,255,255,0.2)] z-0 hidden sm:flex flex-col items-center justify-between py-8 border-y-2 border-transparent" style={{ background: t.sidePlate, borderRightColor: t.sideBorder }}>
                    <div className="w-4 h-4 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.3)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                        <div className="w-2.5 h-[1.5px] rotate-45" style={{ background: t.screwLine }}></div>
                    </div>
                    {/* Glowing side hole */}
                    <div className="w-3 h-3 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.3)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                        <div className={`w-1.5 h-1.5 rounded-full ${t.ledColor} ${t.ledShadow}`}></div>
                    </div>
                </div>
                <div className="absolute top-0 right-0 w-8 md:w-[60px] lg:w-[120px] h-full border-l-[4px] shadow-[inset_4px_0_15px_rgba(0,0,0,0.4),_inset_-2px_0_10px_rgba(255,255,255,0.2)] z-0 hidden sm:flex flex-col items-center justify-between py-8 border-y-2 border-transparent" style={{ background: t.sidePlate, borderLeftColor: t.sideBorder }}>
                    <div className="w-4 h-4 rounded-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.3)] flex items-center justify-center" style={{ background: t.sideBorder }}>
                        <div className="w-2.5 h-[1.5px] rotate-45" style={{ background: t.screwLine }}></div>
                    </div>
                    <div className="w-3 h-3 rounded-full bg-[#0a2780] shadow-[inset_0_2px_4px_rgba(0,0,0,0.9),0_1px_1px_rgba(255,255,255,0.3)] flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center w-full max-w-[1240px] px-2 py-3 lg:px-4 lg:py-4">
                    ...
                    <div className="w-full rounded-[16px] border-[2px] border-b-[4px] border-t-black/40 border-l-black/30 shadow-[inset_0_15px_30px_rgba(0,0,0,0.8),0_2px_0_rgba(255,255,255,0.08)] p-3 lg:p-4 flex flex-col xl:flex-row gap-4 lg:gap-6 items-stretch relative" style={{ background: t.panelGrad, borderRightColor: t.panelBorderR + '66', borderBottomColor: t.panelBorderB + '99' }}>
                        ...
                        <div className="flex flex-col justify-between pl-4 pr-6 py-2 relative min-w-[260px] shrink-0 border-b xl:border-b-0 xl:border-r-[2px] border-[#1e4dc8]/50 pb-4 xl:pb-0">
                            {/* Inset shadow line simulating a groove on the right */}
                            <div className="hidden xl:block absolute right-0 top-0 h-full w-[1.5px] bg-[#0a206a] shadow-[1px_0_0_rgba(255,255,255,0.1)]"></div>
                            ...
                            <div className="relative z-10 pt-1 lg:mt-2">
                                ...
                                <p className="text-white/90 text-[11px] font-bold mt-3 tracking-wide capitalize drop-shadow-md">Creative Designer & Illustrator</p>
                            </div>
                        ...
                        <div className="flex-grow flex flex-col gap-3 lg:gap-4 xl:gap-5 justify-between lg:py-1 w-full min-w-0">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between gap-4 h-auto lg:h-[46px] w-full">
                                ...
                                <div className="flex gap-2 lg:gap-3 shrink-0 items-center justify-start sm:justify-end pl-2 sm:pl-0 sm:border-l-[2px] border-[#1e4dc8]/50 sm:ml-2 relative">
                            ...
                            <div className="flex flex-col lg:flex-row lg:flex-wrap xl:flex-nowrap gap-3 xl:gap-4 h-auto xl:h-[95px] w-full pt-1 lg:pt-0 justify-center xl:justify-start min-w-0">
                                ...
                                <div className="flex-1 w-full lg:w-auto min-w-[160px] xl:min-w-[180px] h-[100px] xl:h-[95px] bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#38bdf8]/50 border-b-[#38bdf8] shadow-[inset_0_4px_25px_rgba(0,0,0,1),inset_0_-2px_15px_rgba(56,189,248,0.2),0_4px_6px_rgba(0,0,0,0.4)] p-2 relative overflow-hidden flex items-center justify-center shrink group">
                                    ...
                                    {/* Grid background */}
                                    <div className="absolute inset-0 bg-[linear-gradient(rgba(56,189,248,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(56,189,248,0.15)_1px,transparent_1px)] bg-[size:10px_10px] pointer-events-none opacity-50"></div>
                                    <div className="absolute inset-0 bg-gradient-to-t from-transparent via-[#020b1e]/60 to-[#020b1e]/90"></div>

                                    {/* Left Graph Bars */}
                                    <div className="absolute left-3 bottom-0 flex gap-[3px] items-end opacity-90 pb-3">
                                        <div className="w-1.5 h-6 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm"></div>
                                        <div className="w-1.5 h-12 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm"></div>
                                        <div className="w-1.5 h-5 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm opacity-60"></div>
                                        <div className="w-1.5 h-14 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm"></div>
                                        <div className="w-1.5 h-9 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm"></div>
                                    </div>

                                    {/* Globe Graphic (Wireframe Style SVG) */}
                                    <div className="relative w-20 h-20 rounded-full border-[1.5px] border-[#38bdf8] shadow-[0_0_20px_#38bdf8] flex items-center justify-center z-10 bg-[#071638]/40 overflow-hidden">
                                        <svg className="w-[120%] h-[120%] text-[#38bdf8] opacity-80 animate-[spin_30s_linear_infinite]" viewBox="0 0 100 100">
                                    ...
                                    <div className="absolute right-3 bottom-0 flex gap-[3px] items-end pb-3">
                                        <div className="w-1.5 h-10 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm opacity-70"></div>
                                        <div className="w-1.5 h-6 bg-[#4ade80] shadow-[0_0_8px_#4ade80] rounded-t-sm"></div>
                                        <div className="w-1.5 h-14 bg-[#4ade80] shadow-[0_0_8px_#4ade80] rounded-t-sm"></div>
                                        <div className="w-1.5 h-8 bg-[#38bdf8] shadow-[0_0_8px_#38bdf8] rounded-t-sm opacity-50"></div>
                                    </div>
                                </div>

                                {/* STATUS BOX (Center) */}
                                <div className="flex flex-col justify-between w-full sm:w-[200px] xl:w-[200px] h-auto xl:h-[95px] gap-2 shrink-0 xl:shrink bg-gradient-to-b from-[#0b1736] to-[#060e24] p-2.5 rounded-[10px] border-[2px] border-t-black/60 border-l-black/40 border-r-[#1e3a8a]/50 border-b-[#1e3a8a]/80 shadow-[inset_0_4px_15px_rgba(0,0,0,0.9),0_4px_6px_rgba(0,0,0,0.4)] relative">
                                    {/* Top Status LCD */}
                                    <div className="h-10 lg:h-[42px] bg-[#020512] rounded-[6px] border border-t-black border-b-[#1e40af]/40 shadow-[inset_0_4px_10px_rgba(0,0,0,1)] flex items-center justify-center px-4 relative overflow-hidden">
                                        <div className="absolute inset-0 bg-[#38bdf8] opacity-5 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,#38bdf8_2px,#38bdf8_4px)] pointer-events-none"></div>
                                    ...
                                    <div className="flex-1 flex gap-2">
                                        <div className="flex-1 bg-[#020512] rounded-[6px] border border-t-black border-b-[#1e40af]/40 shadow-[inset_0_3px_8px_rgba(0,0,0,1)] flex items-center justify-center gap-2 px-1 relative overflow-hidden">
                                            <div className="absolute top-0 left-0 right-0 h-1/3 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></div>
                                            <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[#86efac] to-[#166534] border border-[#064e3b] shadow-[0_0_12px_#4ade80,inset_0_1px_1px_rgba(255,255,255,0.6)] animate-[pulse_2s_ease-in-out_infinite]"></div>
                                ...
                                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0 min-w-0 xl:h-[95px] justify-end sm:ml-auto">
                                    {/* Envelope Screen */}
                                    <div className="w-full sm:w-[140px] xl:w-[140px] h-[90px] xl:h-[95px] bg-[#02071a] rounded-[10px] border-[2px] border-t-[#0a206a] border-l-[#0a206a] border-r-[#38bdf8]/50 border-b-[#38bdf8] shadow-[inset_0_4px_25px_rgba(0,0,0,1),inset_0_-2px_15px_rgba(56,189,248,0.2),0_4px_6px_rgba(0,0,0,0.4)] relative overflow-hidden flex items-center justify-center shrink-0 group">
                                        {/* Glass reflection top */}
                                        <div className="absolute top-0 left-0 right-0 h-1/4 bg-gradient-to-b from-white/10 to-transparent z-20 pointer-events-none"></div>

                                        {/* Scanner Grid Background */}
                                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.15)_0%,transparent_70%)] opacity-80"></div>
                                        <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_49%,rgba(56,189,248,0.3)_50%,transparent_51%),linear-gradient(transparent_49%,rgba(56,189,248,0.3)_50%,transparent_51%)] bg-[size:200%_200%] animate-[spin_10s_linear_infinite] opacity-30"></div>

                                        {/* Glowing ellipse */}
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100px] h-[30px] border-[2px] border-[#38bdf8]/60 rounded-[100%] shadow-[0_0_15px_#38bdf8,inset_0_0_10px_#38bdf8]"></div>
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120px] h-[50px] border border-[#38bdf8]/30 rounded-[100%]"></div>
                                        ...
                                        <div className="absolute right-2 bottom-2 text-[#38bdf8] opacity-60 text-[6px] font-mono leading-none tracking-widest text-right">
                                            <div>SYS.89.2</div>
                                            <div>LINK DET</div>
                                        </div>
                                    </div>
                ...
                <div className="flex w-full items-stretch justify-center border-t-[3px] h-[36px] md:h-[42px] px-auto relative z-20 shadow-[0_-5px_15px_rgba(0,0,0,0.2)]" style={{ background: t.stripBg, borderTopColor: t.stripBorder }}>

                    {/* Left bevel segment */}
                    <div className={`flex-1 border-t ${t.bevelBorderT} shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] flex items-center justify-start px-6 md:px-12 relative`} style={{ background: t.bevelBg }}>
                        {/* Screws */}
                        <div className={`hidden sm:block absolute left-4 w-2 h-2 rounded-full ${t.screwDot} shadow-[inset_0_1px_1px_rgba(0,0,0,0.8)]`}></div>
                        ...
                        <div className={`absolute right-[-10px] top-0 h-full w-[20px] transform skew-x-[30deg] border-t ${t.bevelBorderT} z-10`} style={{ background: t.bevelBg, borderRightColor: t.sideBorder }}></div>
                    </div>

                    {/* Center KPIs & Control Room Dashboard (Recessed) */}
                    <div className="shrink-0 w-[240px] md:w-[360px] bg-[#020817] shadow-[inset_0_2px_6px_rgba(0,0,0,0.9)] flex flex-col justify-center gap-[2px] md:gap-1 px-2 md:px-4 relative z-0 border-x-2 border-[#0a206a]/50 py-1">
                        {/* Upper Info Row */}
                        <div className="flex justify-between w-full px-2">
                            <span className="text-[#38bdf8] text-[7px] md:text-[9px] font-mono tracking-widest font-bold drop-shadow-[0_0_2px_#38bdf8]">SYS_CTRL_NODE</span>
                        ...
                        <div className="flex items-center justify-center gap-2 md:gap-4 w-full px-2">
                            ...
                            <div className="flex gap-2.5">
                                <div className="w-2 md:w-2.5 h-2 md:h-2.5 bg-[#4ade80] rounded-full shadow-[0_0_8px_#4ade80,inset_0_1px_1px_rgba(255,255,255,0.8)] opacity-90"></div>
                    ...
                    {/* Right bevel segment */}
                    <div className={`flex-1 border-t ${t.bevelBorderT} shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] flex items-center justify-end px-6 md:px-12 relative`} style={{ background: t.bevelBg }}>
                        {/* Angled cut visual simulator */}
                        <div className={`absolute left-[-10px] top-0 h-full w-[20px] transform skew-x-[-30deg] border-t ${t.bevelBorderT} z-10`} style={{ background: t.bevelBg, borderLeftColor: t.sideBorder }}></div>
                        ...
                        {/* Screws */}
                        <div className={`hidden sm:block absolute right-4 w-2 h-2 rounded-full ${t.screwDot} shadow-[inset_0_1px_1px_rgba(0,0,0,0.8)] z-20`}></div>
                    </div>
                </div>
